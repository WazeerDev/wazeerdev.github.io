...
function bu(e, t, n) {
  ...
  for (r in t) Sc.call(t, r) && !Nc.hasOwnProperty(r) && (l[r] = t[r]);
  if (e && e.defaultProps)
 ...
 */ (function (e) {
      ...
      e: for (var W = 0, X = N.length, bn = X >>> 1; W < bn; ) {
        ...
        if (0 > l(gl, z))
          vt < X && 0 > l(er, gl)
            ? ((N[W] = er), (N[vt] = z), (W = vt))
            : ((N[W] = gl), (N[ht] = z), (W = ht));
        else if (vt < X && 0 > l(er, z)) (N[W] = er), (N[vt] = z), (W = vt);
        else break e;
      }
    }
    return j;
  ...
  function y(N) {
    if (((k = !1), d(N), !x))
      if (n(s) !== null) (x = !0), vl(E);
      else {
        var j = n(c);
        j !== null && yl(y, j.startTime - N);
      }
  }
  function E(N, j) {
    ...
    try {
      ...
      if (m !== null) var bn = !0;
        ...
        var ht = n(c);
        ht !== null && yl(y, ht.startTime - j), (bn = !1);
      }
      return bn;
    } finally {
      (m = null), (p = z), (w = !1);
      ...
      return (
        ...
        z > W
          ? ((N.sortIndex = z),
            ...
            n(s) === null &&
              N === n(c) &&
              (k ? (f(P), (P = -1)) : (k = !0), yl(y, z - W)))
          : ((N.sortIndex = X), t(s, N), x || w || ((x = !0), vl(E))),
        N
      );
    }),
...
function Uc(e, t, n, r, l, i, o, u, s) {
  (Sn = !1), (Tr = null), Dc.apply(Fc, arguments);
}
function $c(e, t, n, r, l, i, o, u, s) {
  if ((Uc.apply(this, arguments), Sn)) {
    if (Sn) {
      var c = Tr;
      (Sn = !1), (Tr = null);
...
function bc(e, t, n, r, l) {
  switch (t) {
    ...
    case "pointerover":
      var i = l.pointerId;
      return In.set(i, fn(In.get(i) || null, e, t, n, r, l)), !0;
    case "gotpointercapture":
      return (
...
var yf = V({}, Zn, {
  ...
  kf = we(xf),
  Sf = V({}, ln, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Ef = we(Sf),
  Nf = V({}, nl, {
    deltaX: function (e) {
...
function zf(e, t) {
  if (It)
    return e === "compositionend" || (!no && Ds(e, t))
      ? ((e = Is()), (kr = bi = et = null), (It = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function ru() {
  Nn && (Nn.detachEvent("onpropertychange", As), (Fn = Nn = null));
}
function As(e) {
  if (e.propertyName === "value" && rl(Fn)) {
    var t = [];
    Us(t, Fn, e, Gi(e)), ws(Tf, t);
  }
}
function Of(e, t, n) {
  e === "focusin"
    ? (ru(), (Nn = t), (Fn = n), Nn.attachEvent("onpropertychange", As))
    : e === "focusout" && ru();
}
function If(e) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              y !== null &&
              ((d = y),
              f !== null && ((y = On(a, f)), y != null && k.push(An(a, y, d)))),
            F)
          )
            break;
          a = a.return;
...
function bs(e, t, n) {
  (xe[ke++] = Ve), (xe[ke++] = Be), (xe[ke++] = Ct), (Ct = e);
  var r = Ve;
  e = Be;
  var l = 32 - Te(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function na(e) {
      ...
      : a !== null &&
        (a.elementType === E ||
          (typeof E == "object" &&
            ...
            E.$$typeof === Ze &&
            yu(E) === a.type))
      ? ((y = l(a, d.props)), (y.ref = mn(f, a, d)), (y.return = f), y)
  ...
  function h(f, a, d, y, E) {
    return a === null || a.tag !== 7
      ? ((a = Et(d, f.mode, y, E)), (a.return = f), a)
      : ((a = l(a, d)), (a.return = f), a);
  }
  function m(f, a, d) {
  ...
  function k(f, a, d, y) {
    ...
    if (T.done) return n(f, _), U && yt(f, P), E;
    if (_ === null) {
...
function yo(e, t, n, r, l, i) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Nr.current = e === null || e.memoizedState === null ? nd : rd),
    (e = n(r, l)),
    _n)
  ) {
    i = 0;
    do {
      if (((_n = !1), (Wn = 0), 25 <= i)) throw Error(g(301));
      (i += 1),
        (Z = Y = null),
        (t.updateQueue = null),
        (Nr.current = ld),
...
function ka(e, t, n) {
  return _t & 21
    ? (Oe(n, t) || ((n = _s()), (A.lanes |= n), (Pt |= n), (e.baseState = !0)),
      t)
  ...
  nd = {
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        ...
        (r.flags |= 2048),
        Kn(9, ca.bind(null, r, i, n, t), void 0, null),
        n
      );
    },
    useId: function () {
...
function zu(e, t, n, r, l) {
  ...
  if ((Gt(t, l), t.stateNode === null))
    _r(e, t), _a(t, n, r), Ei(t, n, r, l), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      u = t.memoizedProps;
    o.props = u;
...
function ud(e, t, n, r, l, i, o) {
  ...
  if (l.data === "$!") {
    ...
    return (r = u), (i = Error(g(419))), (r = Vl(i, r, void 0)), mr(e, t, o, r);
  }
  if (((u = (o & e.childLanes) !== 0), ce || u)) {
    ...
    return Po(), (r = Vl(Error(g(421)))), mr(e, t, o, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || $.current & 1 ? G === 0 && (G = 3) : Po())),
          t.updateQueue !== null && (t.flags |= 4),
          ne(t),
          null);
    case 4:
      return (
        en(), zi(e, t), e === null && $n(t.stateNode.containerInfo), ne(t), null
      );
    case 10:
...
function dd(e, t) {
  ...
  for (mi = { focusedElem: e, selectionRange: n }, Mr = !1, S = t; S !== null; )
...
function Ua(e) {
  ...
  t !== null && ((e.alternate = null), Ua(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[De], delete t[Vn], delete t[yi], delete t[Gf], delete t[Xf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ba(e, t, n) {
  for (var r = (e.mode & 1) !== 0; S !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && i !== null ? ((i.return = l), (S = i)) : Mu(e);
  }
}
function Mu(e) {
  for (; S !== null; ) {
...
function Re(e, t, n, r) {
  if (50 < zn) throw ((zn = 0), (Mi = null), Error(g(185)));
  Xn(e, n, r),
    (!(R & 2) || e !== J) &&
      (e === J && (!(R & 2) && (cl |= n), G === 4 && be(e, b)),
      pe(e, r),
...
function Ha(e, t) {
  if (((Pr = -1), (jr = 0), R & 6)) throw Error(g(327));
  var n = e.callbackNode;
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = Yn), St(e, 0), be(e, r), pe(e, Q()), n);
    if (t === 6) be(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (be(e, r), (r & 130023424) === r && ((t = No + 500 - Q()), 10 < t))
          ) {
            if (Ir(e, 0) !== 0) break;
            ...
            e.timeoutHandle = vi(gt.bind(null, e, ae, $e), t);
            break;
          }
          gt(e, ae, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = vi(gt.bind(null, e, ae, $e), r);
            break;
          }
          gt(e, ae, $e);
          break;
...
function Uu(e) {
  ...
  if (n === 1) throw ((n = Yn), St(e, 0), be(e, t), pe(e, Q()), n);
...
function qr(e, t) {
  ...
  while (!0);
  if ((so(), (R = n), (Xr.current = r), K !== null)) throw Error(g(261));
  return (J = null), (b = 0), G;
}
function vd() {
  for (; K !== null; ) Ka(K);
...
function wd(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    J === e &&
      (b & n) === n &&
      (G === 4 || (G === 3 && (b & 130023424) === b && 500 > Q() - No)
        ? St(e, 0)
        : (Eo |= n)),
    pe(e, t);
}
      ...
      e: {
        ...
        if (((r = o.element), i.isDehydrated))
          if (
            ...
            (l = tn(Error(g(423)), t)), (t = Lu(e, t, r, n, l));
            break e;
          } else if (r !== l) {
            (l = tn(Error(g(424)), t)), (t = Lu(e, t, r, n, l));
            break e;
          } else
            for (
...
ys = Co;
gs = jt;
var jd = { usingClientEntryPoint: !1, Events: [Jn, Ft, il, hs, vs, Co] },
  vn = {
        ...
        children: v.jsxs("div", {
          ...
          children: [
            v.jsx("div", {
              ...
              children: v.jsx("div", {
                className:
                  "relative w-32 h-32 md:w-40 md:h-40 rounded-full glass-morphism p-4 flex items-center justify-center",
                children: v.jsx("img", {
                  src: "Logo.jpeg",
                  alt: "WazeerDev Logo",
            ...
            v.jsx("p", {
              className:
                "text-xl text-white/70 max-w-2xl mx-auto mb-8 leading-relaxed",
              children:
                "Suffering the pain of discipline is better than suffering the pain of regret",
            }),
            v.jsxs("div", {
              className:
              ...
              children: [
                v.jsx("button", {
                  onClick: () => {
                    var e;
                    return (e = document.getElementById("about")) == null
                      ? void 0
                      : e.scrollIntoView({ behavior: "smooth" });
                  },
                  className:
                    "glass-hover text-white border-white/20 hover:bg-white/20 px-8 py-3 text-lg rounded-lg",
                  children: "Discover More",
                }),
                v.jsx("button", {
                  onClick: () => {
                    var e;
                    return (e = document.getElementById("contact")) == null
                      ? void 0
                      : e.scrollIntoView({ behavior: "smooth" });
                  },
                  className:
        ...
        children: [
          v.jsxs("div", {
            ...
            children: [
              v.jsx("h2", {
                className:
                  "text-4xl md:text-5xl font-bold mb-4 animate-fade-in-up",
                children: v.jsx("span", {
                  className: "gradient-text",
                  children: "About Me",
                }),
              ...
              v.jsx("div", {
                className:
                  "w-24 h-1 bg-gradient-to-r from-purple-400 to-pink-400 mx-auto rounded",
              }),
            ],
          }),
          v.jsxs("div", {
            ...
            children: [
              v.jsxs("div", {
                className:
                  "glass-morphism rounded-lg p-6 text-center animate-fade-in-up stagger-animation",
                children: [
                  v.jsx("div", { className: "text-3xl mb-4", children: "🚀" }),
                  v.jsx("h3", {
              ...
              v.jsxs("div", {
                ...
                children: [
                  ...
                  v.jsx("p", {
                    className: "text-white/70",
                    children:
                      "Currently learning advanced web development and APIs. Always striving to expand my knowledge and stay up-to-date with the latest technologies.",
                  }),
                ],
              }),
              v.jsxs("div", {
                ...
                children: [
                  ...
                  v.jsx("p", {
                    className: "text-white/70",
                    children:
                      "My goal is to become a senior full-stack developer, creating innovative solutions that make a difference in people's lives.",
                  }),
                ],
              }),
            ],
          ...
          v.jsx("div", {
            className: "mt-12 text-center max-w-3xl mx-auto animate-fade-in-up",
            children: v.jsx("p", {
              className: "text-lg text-white/80 leading-relaxed",
              children:
                "For me, coding is where logic meets creativity. I believe in writing clean, efficient code and building applications that not only work well but also provide exceptional user experiences.",
            }),
          }),
        ],
      }),
              ...
              v.jsx("div", {
                ...
                children: e.map((n) =>
                  v.jsxs(
                    ...
                    {
                      className:
                        "skill-morphism animate-fade-in-up stagger-animation",
                      children: [
                        v.jsx("div", {
      ...
      children: v.jsxs("div", {
        ...
        children: [
          ...
          v.jsx("div", {
            ...
            children: v.jsxs("div", {
              className:
                "glass-morphism rounded-lg p-12 text-center animate-fade-in-up",
              children: [
                v.jsx("div", { className: "text-6xl mb-6", children: "🚧" }),
                v.jsx("h3", {
                ...
                v.jsx("p", {
                  ...
                  children:
                    "I'm currently working on exciting new projects that will showcase my skills and creativity. Stay tuned for updates!",
                }),
                v.jsx("p", {
                  className: "text-white/60",
                  children:
                    "In the meantime, feel free to check out my GitHub profile for more of my work.",
                }),
              ],
            }),
          }),
    ...
    const e = [
      {
        name: "LinkedIn",
        icon: "💼",
        url: "https://linkedin.com/in/wazeerdev",
      },
      { name: "Twitter", icon: "🐦", url: "https://twitter.com/WazeerDev" },
      {
        name: "Facebook",
        icon: "📘",
        url: "https://facebook.com/profile.php?id=61580617264991",
      },
      { name: "Email", icon: "✉️", url: "mailto:contact.wazeerdev@gmail.com" },
    ];
    return v.jsx("section", {
      id: "contact",
      className: "section-padding",
        ...
        children: [
          ...
          v.jsxs("div", {
            ...
            children: [
              v.jsxs("div", {
                className:
                  "glass-morphism rounded-lg p-8 mb-8 animate-fade-in-up",
                children: [
                  v.jsx("h3", {
                    className:
                      "text-2xl font-semibold mb-6 text-center text-white",
                    children: "Get In Touch",
                  }),
                  v.jsx("p", {
                    className: "text-white/70 text-center mb-8",
                    children:
                      "I'm always interested in hearing about new opportunities and exciting projects. Feel free to reach out if you'd like to collaborate or just say hello!",
                  }),
                  v.jsx("div", {
                    ...
                    children: e.map((t) =>
                      v.jsxs(
                        "a",
                        {
                          ...
                          className:
                            "glass-hover rounded-lg p-4 text-center transition-all duration-300 hover:scale-105",
                          children: [
                            v.jsx("div", {
              ...
              v.jsx("div", {
                ...
                children: v.jsx("p", {
                  className: "text-white/60",
                  children:
                    "© 2025 WazeerDev. Built with passion and precision.",
                }),
              }),
            ],
          }),
...
Ql.createRoot(document.getElementById("root")).render(
  v.jsx(gc.StrictMode, { children: v.jsx(Fd, {}) })
);
